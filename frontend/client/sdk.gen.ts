...
export const getProjectStl = <ThrowOnError extends boolean = false>(options: Options<GetProjectStlData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProjectStlResponse, GetProjectStlError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
