...
const registerHandler: RequestHandler = async (req: RegisterRequest, res: Response): Promise<void> => {
  /* #swagger.tags = ['Auth']
     ...
     #swagger.operationId = 'createUserWithWorkspace'
     #swagger.description = 'Creates a new user account with a default organization workspace. Handles password hashing and organization setup.'
     #swagger.requestBody = {
       required: true,
       content: {
         'application/json': {
