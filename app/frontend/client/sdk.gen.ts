...
export const getProjectScad = <ThrowOnError extends boolean = false>(options: Options<GetProjectScadData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetProjectScadResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Get latest STL for a project
 * Get the latest STL for a project. If no objects exist, return an empty string.
 */
export const getProjectStl = <ThrowOnError extends boolean = false>(options: Options<GetProjectStlData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetProjectStlResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * Uses Gemini AI to generate 3D objects and scene state based on text instructions
 */
