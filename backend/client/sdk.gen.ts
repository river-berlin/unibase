 ...
 * Retrieve a specific JavaScript file associated with a project by filename and optional filepath.
 */
...
/**
 * Get index.js from a project in a workspace
 * Retrieve the index.js file from a specified project in a workspace.
 */
export const getProjectIndexByWorkspaceAndProject = <ThrowOnError extends boolean = false>(options: Options<GetProjectIndexByWorkspaceAndProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProjectIndexByWorkspaceAndProjectResponse, GetProjectIndexByWorkspaceAndProjectError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Get a specific file from a project in a workspace
 * Retrieve a specific JavaScript file from a project in a workspace using the @dev.js suffix.
 */
export const getProjectFileByWorkspaceAndProject = <ThrowOnError extends boolean = false>(options: Options<GetProjectFileByWorkspaceAndProjectData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetProjectFileByWorkspaceAndProjectResponse, GetProjectFileByWorkspaceAndProjectError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Get index.js from the default project in a workspace
 * Retrieve the index.js file from the project named "index" in the specified workspace.
 */
export const getDefaultProjectIndexByWorkspace = <ThrowOnError extends boolean = false>(options: Options<GetDefaultProjectIndexByWorkspaceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetDefaultProjectIndexByWorkspaceResponse, GetDefaultProjectIndexByWorkspaceError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
